...
This was a fun little project to implement custom enumerable methods that can also utilize blocks. This repository is the completed project for Custom Enumerabl Project from The Odin Project Curriculum as described below.
